...
const en: Dict = {
  ...
  daily_routine_reminder: 'Daily Routine Reminder',
  ...
  start_music_session: 'Start Music Session',
  start_breathing_exercise: 'Start Breathing Exercise',
  start_feldenkrais_exercise: 'Start Movement Practice',
  start_game: 'Start Game',
  music_session_completed: 'Music Session Completed',
  retake_music_session: 'Retake Music Session',
  retake_breathing_exercise: 'Retake Breathing Exercise',
  retake_feldenkrais_exercise: 'Retake Feldenkrais Movement',
  retake_game: 'Retake Game',
  ...
  feldenkrais_movement: 'Gentle Movements',
  feldenkrais_description: 'Feldenkrais - gentle movements to improve body awareness and flexibility.',
  ...
  goals_completed_on: 'Goals completed on',
  goals_on: 'Goals on',
  daily_activities: 'Daily Activities',
  approve: 'Approve',
  completed_goals: 'Completed Goals',
  completed_activities: 'Completed Activities',
  uncompleted_goals: 'Uncompleted Goals',
  no_completions: 'No completions on this day',
  ...
  read_more_external: 'Read more on external site →',
  ...
  contact_form_description: 'Send us a message and we will get back to you as soon as possible.',
  message: 'Message',
  enter_full_name: 'Enter your full name',
  enter_message: 'Enter your message here',
  play_demo: 'Play Demo',
  demo_description: 'Watch a video presentation to learn how to use the app',
  watch_demo: 'Watch Demo',
  watch_demo_title: 'Would you like to watch a demo?',
  watch_demo_description: 'We can show you a quick demo video explaining how to use the app',
  skip: 'Skip',
  ...
  // Notifications
  notification_new_content: 'New Content Available',
  notification_new_content_desc: 'We\'ve added 5 new Feldenkrais movement exercises and 3 new breathing techniques for you to explore.',
  notification_daily_reminder: 'Daily Routine Reminder',
  notification_daily_reminder_desc: 'Don\'t forget to complete your daily activities! You have 3 exercises left to maintain your streak.',
  notification_app_update: 'App Updated Successfully',
  notification_app_update_desc: 'Brain Power has been updated with improved performance, new features, and bug fixes. Enjoy the enhanced experience!',
  notification_maintenance: 'Scheduled Maintenance',
  notification_maintenance_desc: 'The AI assistant may be temporarily unavailable on Nov 15 from 2-4 AM for system maintenance.',
  // Announcements
  announcements_title: 'Announcements',
  announcement_new_exercises: 'New Exercise Series Released',
  announcement_new_exercises_desc: 'Introducing our new "Morning Energy" series with 7 exercises designed to help you start your day with vitality and focus. Perfect for all fitness levels!',
  announcement_workshop: 'Free Online Workshop',
  announcement_workshop_desc: 'Join us for a live workshop on "Holistic Wellness for Seniors" on November 20th at 10:00 AM. Register through WhatsApp to save your spot!',
  announcement_community: 'Community Milestone',
  announcement_community_desc: 'We\'ve reached 10,000 active users! Thank you for being part of our growing community dedicated to health and wellness.',
  announcement_category_content: 'Content',
  announcement_category_event: 'Event',
  announcement_category_community: 'Community',
  // Quick Tips
  ...
  choose_feldenkrais_type: 'Choose Your Feldenkrais Movement Video',
  ...
  feldenkrais_completed_message: 'You have successfully completed the Feldenkrais movement session. Excellent work!',
  // Game Options
  choose_game_type: 'Choose Your Game',
  select_game_preference: 'Select a game to challenge your memory and cognitive skills',
  memory_game_image_patterns: 'Memory Game - Image Patterns',
  select_difficulty: 'Select Difficulty',
  choose_your_level: 'Choose your challenge level',
  beginner_desc: '4 tiles - 5 seconds to memorize',
  advanced_desc: '6 tiles - 10 seconds to memorize',
  grand_master_desc: '8 tiles - 15 seconds to memorize',
  // Memory Game
  memorize_pattern: 'Memorize the Pattern',
  pattern_will_hide_in: 'Pattern will hide in',
  seconds: 'seconds',
  watch_carefully_pattern: 'Watch carefully and remember the pattern',
  recreate_pattern: 'Recreate the Pattern',
  drag_pieces_to_grid: 'Drag the colored pieces to recreate the pattern you saw',
  your_pattern: 'Your Pattern',
  available_pieces: 'Available Pieces',
  used: 'Used',
  click_to_remove: 'Click to remove',
  pattern_matched: 'You successfully matched the pattern!',
  not_quite_right: 'Not Quite Right',
  pattern_mismatch: 'The pattern doesn\'t match. Try again!',
...
const he: Dict = {
  ...
  grand: 'גראנד מאסטר',
  grand_master: 'מאסטר',
  choose_level: 'בחרו רמה',
  change_level: 'שנו רמה',
  choose_font_size: 'בחרו גודל גופן',
  choose_language: 'בחרו שפה',
  font_size_small: 'קטן',
  font_size_medium: 'בינוני',
  font_size_large: 'גדול',
  font_size_extra_large: 'גדול מאוד',
  intro_tile_h: 'מבוא',
  ...
  daily_routine_reminder: 'תזכורת שגרה יומית',
  set_reminder: 'הגדירו תזכורת',
  reminder_name: 'שם תזכורת',
  reminder_time: 'שעת תזכורת',
  enter_reminder_name: 'הזינו שם תזכורת',
  save_reminder: 'שמור תזכורת',
  delete_reminder: 'מחק תזכורת',
  no_reminders: 'לא הוגדרו תזכורות',
  reminder_saved: 'התזכורת נשמרה בהצלחה',
  ...
  start_breathing_exercise: 'התחילו תרגול נשימה',
  start_feldenkrais_exercise: 'התחילו תרגול תנועות',
  start_game: 'התחילו משחק',
  music_session_completed: 'תרגול מוזיקלי הושלם',
  retake_music_session: 'חזור על התרגול המוזיקלי',
  retake_breathing_exercise: 'חזור על תרגיל הנשימה',
  retake_feldenkrais_exercise: 'חזור על תנועות פלדנקרייז',
  retake_game: 'חזור על המשחק',
  start_video: 'התחל וידאו',
  play_video: 'נגנו',
  enter_fullscreen: 'מסך מלא',
  ...
  feldenkrais_movement: 'תנועות עדינות',
  feldenkrais_description: 'פלדנקרייז - תנועות עדינות לשיפור המודעות הגופנית והגמישות.',
  ...
  progress_calendar: 'לוח התקדמות',
  goals_completed_on: 'יעדים שהושלמו ב',
  goals_on: 'יעדים ב',
  daily_activities: 'פעילויות יומיות',
  approve: 'אישור',
  completed_goals: 'יעדים שהושלמו',
  completed_activities: 'פעילויות שהושלמו',
  uncompleted_goals: 'יעדים שלא הושלמו',
  no_completions: 'אין השלמות ביום זה',
  no_goals: 'אין יעדים מוגדרים',
  // Article translations
  ...
  read_full_article: 'הרחיבו',
  read_more_external: 'קראו עוד באתר חיצוני ←',
  ...
  whatsapp: 'WhatsApp',
  contact_us: 'צרו קשר',
  contact_form_description: 'שלחו לנו הודעה ונחזור אליכם בהקדם האפשרי.',
  message: 'הודעה',
  enter_full_name: 'הזינו את שמכם המלא',
  enter_message: 'הזינו את ההודעה שלכם כאן',
  play_demo: 'נגן הדגמה',
  watch_demo: 'צפו בהדגמה',
  watch_demo_title: 'האם תרצו לצפות בהדגמה?',
  watch_demo_description: 'אנחנו יכולים להראות לכם סרטון הדגמה קצר שמסביר איך להשתמש באפליקציה',
  skip: 'דלג',
  play_music: 'נגנו מוזיקה',
  stop_music: 'הפסיקו מוזיקה',
  demo_description: 'צפו במצגת וידאו כדי ללמוד כיצד להשתמש באפליקציה',
  ...
  // Notifications
  notification_new_content: 'תוכן חדש זמין',
  notification_new_content_desc: 'הוספנו 5 תרגילי תנועת פלדנקרייז חדשים ו-3 טכניקות נשימה חדשות לחקירה שלכם.',
  notification_daily_reminder: 'תזכורת שגרה יומית',
  notification_daily_reminder_desc: 'אל תשכחו להשלים את הפעילויות היומיות שלכם! נותרו לכם 3 תרגילים כדי לשמור על הרצף שלכם.',
  notification_app_update: 'האפליקציה עודכנה בהצלחה',
  notification_app_update_desc: 'Brain Power עודכנה עם ביצועים משופרים, תכונות חדשות ותיקוני באגים. תהנו מהחוויה המשופרת!',
  notification_maintenance: 'תחזוקה מתוכננת',
  notification_maintenance_desc: 'עוזר ה-AI עשוי להיות לא זמין זמנית ב-15 בנובמבר משעה 2-4 בבוקר לתחזוקת מערכת.',
  // Announcements
  announcements_title: 'הודעות',
  announcement_new_exercises: 'סדרת תרגילים חדשה שוחררה',
  announcement_new_exercises_desc: 'מציגים את הסדרה החדשה שלנו "אנרגיית הבוקר" עם 7 תרגילים המיועדים לעזור לכם להתחיל את היום עם חיוניות ומיקוד. מושלם לכל רמות הכושר!',
  announcement_workshop: 'סדנה מקוונת בחינם',
  announcement_workshop_desc: 'הצטרפו אלינו לסדנה חיה על "בריאות הוליסטית למבוגרים" ב-20 בנובמבר בשעה 10:00 בבוקר. הירשמו דרך WhatsApp כדי לשמור את מקומכם!',
  announcement_community: 'אבן דרך קהילתית',
  announcement_community_desc: 'הגענו ל-10,000 משתמשים פעילים! תודה שאתם חלק מהקהילה ההולכת וגדלה שלנו המוקדשת לבריאות ורווחה.',
  announcement_category_content: 'תוכן',
  announcement_category_event: 'אירוע',
  announcement_category_community: 'קהילה',
  // Quick Tips
  ...
  choose_feldenkrais_type: 'בחרו את סרטון התנועות שלכם',
  ...
  feldenkrais_completed_message: 'השלמתם בהצלחה את תרגיל התנועות. עבודה מצוינת!',
  // Game Options
  choose_game_type: 'בחרו משחק',
  select_game_preference: 'בחרו משחק כדי לאתגר את הזיכרון והכישורים הקוגניטיביים שלכם',
  memory_game_image_patterns: 'משחק זיכרון - דפוסי תמונה',
  select_difficulty: 'בחירת רמת קושי',
  choose_your_level: 'בחרו את רמת האתגר שלכם',
  beginner_desc: '4 אריחים - 5 שניות לשינון',
  advanced_desc: '6 אריחים - 10 שניות לשינון',
  grand_master_desc: '8 אריחים - 15 שניות לשינון',
  // Memory Game
  memorize_pattern: 'שימרו את הדפוס',
  pattern_will_hide_in: 'הדפוס ייעלם בעוד',
  seconds: 'שניות',
  watch_carefully_pattern: 'צפו בעיון וזכרו את הדפוס',
  recreate_pattern: 'צרו מחדש את הדפוס',
  drag_pieces_to_grid: 'גררו את החלקים הצבעוניים כדי ליצור מחדש את הדפוס שראיתם',
  your_pattern: 'הדפוס שלכם',
  available_pieces: 'חלקים זמינים',
  used: 'משומש',
  click_to_remove: 'לחצו להסרה',
  pattern_matched: 'הצלחתם להתאים את הדפוס!',
  not_quite_right: 'לא בדיוק נכון',
  pattern_mismatch: 'הדפוס לא תואם. נסו שוב!',
  play_again: 'שחקו שוב',
  try_again: 'נסו שוב',
  back_to_activities: 'חזרה לפעילויות',
  time: 'זמן',
  score: 'ציון',
  // Music Session
